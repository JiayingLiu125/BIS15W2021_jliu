...
R is an open source, scripting language; RStudio is the Graphical User Interface (GUI) interacting with R. GitHub is a file storage and management site used by programmers. Programmers upload code to repositories to make it publicly available. 
...
I edited my repository through README.md.
...
The value 3.14159265359 is now stored as "pi".
