...
```r
another_new_vector <- my_vector_sequence[my_vector_sequence <= 15]
```
...
```
##  Philosophers_Stone  Chamber_of_Secrets Prisoner_of_Azkaban      Goblet_of_Fire 
##               317.5               261.9               249.5               290.0
```
