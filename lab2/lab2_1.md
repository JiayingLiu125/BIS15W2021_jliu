...
Since there is an "NA" value in the list, mean cannot be calculated, shown here as "NA".
...
## [1] 5.888889
```
It is useful because the rest of the data can be calculated by removing the NA from the list.
